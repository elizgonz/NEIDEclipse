...
for i in range(0,len(line_list)):    
    ...
    axs[0].plot(UTC_time, projected_RV_SSD_4parameter_array, color = 'b', linestyle = "--", linewidth = 2, label = "Model I-EDP: {} m/s".format(rms1))
    axs[0].plot(UTC_time, grass_off_SSD_4parameter_array, color = 'y', linestyle = "--", linewidth = 2, label = "Model II-EDP: {} m/s".format(rms2))
